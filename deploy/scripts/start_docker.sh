...
docker pull 957417441966.dkr.ecr.ap-south-1.amazonaws.com/yt-chrome-plugin:latest
...
docker run -d -p 80:5000 --name campusx-app 957417441966.dkr.ecr.ap-south-1.amazonaws.com/yt-chrome-plugin:latest
